  ...
  renderCards() {
    ...
    const items = [
      ...
      },
      {
        ...
        description:
          "A request tries to withdraw money from the contract.Requests must be approved by apprevers.",
      },
      {
        header: approversCount,
        meta: "Number of Approvers",
        description:
          "A number of people who have already donated to this campaign",
      },
      {
